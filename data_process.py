...
with h5py.File(h5_file_path, 'w') as h5_file:
    ...
    if task_name == 'MFF':
        ...
        for sample_name in tqdm(sample_names):
            if dataset_mode == 'train' and size == 'small':
                img_A = image_read_cv2(
                    os.path.join(img_text_path, 'Image', task_name, dataset_name, 'MRI', sample_name + '.png'),
                    mode='GRAY')
                h, w = img_A.shape
                if h < w:
                    img_A = cv2.resize(img_A, small_size_0)[None, ...] / 255.0
                    img_B = cv2.resize(image_read_cv2(
                        os.path.join(img_text_path, 'Image', task_name, dataset_name, 'CT', sample_name + '.png'),
                        mode='GRAY'), small_size_0)[None, ...] / 255.0
                else:
                    img_A = cv2.resize(img_A, small_size_1).T[None, ...] / 255.0
                    img_B = cv2.resize(image_read_cv2(
                        os.path.join(img_text_path, 'Image', task_name, dataset_name, 'CT', sample_name + '.png'),
                        mode='GRAY'), small_size_1).T[None, ...] / 255.0
            else:
                img_A = image_read_cv2(
                    os.path.join(img_text_path, 'Image', task_name, dataset_name, 'NEAR', sample_name + '.png'),
                    mode='GRAY')[None, ...] / 255.0
                img_B = image_read_cv2(
                    os.path.join(img_text_path, 'Image', task_name, dataset_name, 'FAR', sample_name + '.png'),
                    mode='GRAY')[None, ...] / 255.0
            text_feature = np.load(
                os.path.join(img_text_path, 'TextFeature', task_name, dataset_name, sample_name + '.npy'))
        ...
        for sample_name in tqdm(sample_names):
            if dataset_mode == 'train' and size == 'small':
                img_A = image_read_cv2(
                    os.path.join(img_text_path, 'Image', task_name, dataset_name, 'OVER', sample_name + '.png'),
                    mode='GRAY')
                h, w = img_A.shape
                if h < w:
                    img_A = cv2.resize(img_A, small_size_0)[None, ...] / 255.0
                    img_B = cv2.resize(image_read_cv2(
                        os.path.join(img_text_path, 'Image', task_name, dataset_name, 'UNDER', sample_name + '.png'),
                        mode='GRAY'), small_size_0)[None, ...] / 255.0
                else:
                    img_A = cv2.resize(img_A, small_size_1).T[None, ...] / 255.0
                    img_B = cv2.resize(image_read_cv2(
        ...
        for sample_name in tqdm(sample_names):
            if dataset_mode == 'train' and size == 'small':
                img_A = image_read_cv2(
                    os.path.join(img_text_path, 'Image', task_name, dataset_name, 'IR', sample_name + '.png'),
                    mode='GRAY')
                h, w = img_A.shape
                if h < w:
                    img_A = cv2.resize(img_A, small_size_0)[None, ...] / 255.0
                    img_B = cv2.resize(image_read_cv2(
                        os.path.join(img_text_path, 'Image', task_name, dataset_name, 'VI', sample_name + '.png'),
                        mode='GRAY'), small_size_0)[None, ...] / 255.0
                else:
                    img_A = cv2.resize(img_A, small_size_1).T[None, ...] / 255.0
                    img_B = cv2.resize(image_read_cv2(
        ...
        for sample_name in tqdm(sample_names):
            img_A = \
            image_read_cv2(os.path.join(img_text_path, 'Image', task_name, dataset_name, 'MRI', sample_name + '.png'),
                           mode='GRAY')[None, ...] / 255.0
            img_B = \
            image_read_cv2(os.path.join(img_text_path, 'Image', task_name, dataset_name, 'T', sample_name + '.png'),
                           mode='GRAY')[None, ...] / 255.0
            text_feature = np.load(
                os.path.join(img_text_path, 'TextFeature', task_name, dataset_name, sample_name + '.npy'))
